...
complience_halt_loop2: \
        addi a3, a3, -1; \
complience_halt_wait_uart: \
        lw a4, 0 (a2); \
        bne x0, a4, complience_halt_wait_uart;\
        lb a4, 0 (a3); \
        srai a5, a4, 4; \
        andi a5, a5, 0xF; \
        li a6, 10; \
...
notLetter: \
        addi a5, a5, 0x30; \
        sw a5, 0 (a2); \
complience_halt_wait_uart2: \
        lw t0, 0 (a2); \
        bne x0, t0, complience_halt_wait_uart2;\
        srai a5, a4, 0; \
        andi a5, a5, 0xF; \
        li a6, 10; \
...
notLetter2: \
        ...
        addi a0, a0, 16; \
complience_halt_wait_uart3: \
        lw a4, 0 (a2); \
        bne x0, a4, complience_halt_wait_uart3;\
        li a4, 0x0A; \
        sw a4, 0 (a2); \
